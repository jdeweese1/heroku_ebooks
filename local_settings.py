...
TWITTER_SOURCE_ACCOUNTS = ["jaroddeweese"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
DEBUG = environ.get('DEBUG', False)  # Set this to False to start Tweeting live
